...
export class Webhooks {
  ...
  private Verify(
    ...
    const timestampValue = details['t'];
    const signatureValue = details['v1'];
    ...
    const timestampStr = Array.isArray(timestampValue)
      ? timestampValue[0]
      : timestampValue;
    ...
    const signatures = Array.isArray(signatureValue)
      ? signatureValue
      : [signatureValue];
