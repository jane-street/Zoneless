...
ZONELESS_API_URL=https://api-test.zoneless.com`,
    ...
    },
    {
      left: [
        ...
        {
          type: 'paragraph',
          text: 'Your first live key is shown when you create your account. To create or revoke a key later, open <strong>Developers</strong> in the <a href="/docs/platform-dashboard">Platform Dashboard</a>. Switch between live and test mode before managing keys.',
          html: true,
        },
        {
          type: 'heading',
        ...
        {
          type: 'paragraph',
          text: 'The <a href="/docs/self-hosting">setup wizard</a> creates your first platform API key. Your API URL is the address of your instance, such as <code>http://localhost</code> during local development or <code>https://api.yourdomain.com</code> in production.',
          html: true,
        },
      ],
    },
...
const balance = await zoneless.balance.retrieve();`,
    ...
    },
    {
      left: [
        ...
        {
          type: 'paragraph',
          text: 'See <a href="/docs/errors">Errors</a> for response formats and other API error types.',
          html: true,
        },
      ],
    },
    {
      left: [
        { type: 'heading', level: 2, text: 'Next steps' },
        {
          ...
          items: [
            {
              text: '<strong><a href="/docs/api-quickstart">API quickstart</a>:</strong> Make your first Connect API requests',
              html: true,
            },
            {
              text: '<strong><a href="/docs/checkout-api-quickstart">Checkout API quickstart</a>:</strong> Accept a USDC payment',
              html: true,
            },
            {
              text: '<strong><a href="/docs/webhooks">Webhooks</a>:</strong> Verify signed events sent to your server',
              html: true,
            },
          ],
        },
